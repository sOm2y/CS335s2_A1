...
import ezvcard.util.org.apache.commons.codec.binary.*;
...
public class peopleActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			byte[] imageAsBytes = (Base64.decodeBase64(vcardList.getPhotos().get(0)
					.getData()));
			iv1.setImageBitmap(BitmapFactory.decodeByteArray(imageAsBytes, 0,
					imageAsBytes.length));
